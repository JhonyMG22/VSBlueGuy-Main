...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		//add(bg);
		bg = new FlxBackdrop(Paths.image('loading'), XY);
        bg.scrollFactor.set(0.2, 0);
		bg.velocity.x = 10;
		bg.screenCenter();
		add(bg);

		blackshit = new FlxSprite(-80).loadGraphic(Paths.image('creditsbox'));
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['VS Blue Guy Team'],
			['JhonyAnimations',		'jhony',		    'everything lol',								                'https://youtube.com/@JhonyAnimations',	'CC0000'],
			[''],
